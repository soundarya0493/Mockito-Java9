 ...
 * alternative {@link MockMaker} is used</a>.
 *
 ...
 *      initialization of fields annotated with Mockito annotations like {@link Mock}.
...
public class Mockito extends ArgumentMatchers {
    ...
    /**
     * Creates {@link InOrder} object that allows verifying mocks in order.
     *
     * <pre class="code"><code class="java">
     *   InOrder inOrder = inOrder(firstMock, secondMock);
     *
     ...
     * <p>
     * Ignored stubs will also be ignored for verification inOrder, including {@link InOrder#verifyNoMoreInteractions()}.
