...
/**
 * Informs about the mock settings. An immutable view of {@link MockSettings}.
 */
@NotExtensible
public interface MockCreationSettings<T> {
    ...
    /**
     * {@link InvocationListener} instances attached to this mock, see {@link MockSettings#invocationListeners}.
     */
