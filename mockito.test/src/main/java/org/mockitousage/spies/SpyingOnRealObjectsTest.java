...
public class SpyingOnRealObjectsTest extends TestBase {
    ...
    public SpyingOnRealObjectsTest() throws InstantiationException {
    }
    ...
    @Test
    public void shouldBeAbleToMockObjectBecauseWhyNot() throws InstantiationException {
        spy(new Object());
    }
    ...
    @Test
    public void shouldAllowSpyingAnonymousClasses() throws InstantiationException {
        //when
        Foo spy = spy(new Foo() {
            public String print() {
                return "foo";
