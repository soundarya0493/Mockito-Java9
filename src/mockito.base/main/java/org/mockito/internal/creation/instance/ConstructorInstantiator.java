...
public class ConstructorInstantiator implements Instantiator {
    ...
    public <T> T newInstance(Class<T> cls) throws java.lang.InstantiationException {
        return withParams(cls, constructorArgs);
    }

    private <T> T withParams(Class<T> cls, Object... params) throws java.lang.InstantiationException {
